...
export async function POST(request: NextRequest) {
  try {
    ...
    // Service role key를 사용해서 RLS 우회 (verification_codes 테이블 접근)
    console.log('🔑 Using service role key for verification_codes table')
    ...
    // 새 인증 코드 저장
    const insertData = {
      id: crypto.randomUUID(),  // UUID 명시적 생성 (Supabase client 사용 시 필요)
