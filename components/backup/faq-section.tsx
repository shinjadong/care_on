...
const faqs = [
  {
    ...
    answer:
      "네, 오히려 마케팅 경험이 없으신 분들이 더 빠르게 성장합니다. 잘못된 방향으로 굳어진 습관이 없기 때문입니다. 기초��터 차근차근 알려드리며, 사장님의 전문성을 효과적으로 표현하는 방법을 중점적으로 가르칩니다. 단, 기존 경험이 없는 만큼 다른 사장님들에 비해 2배, 3배 이상의 노력을 해주셔야만 합니다.",
  },
  {
