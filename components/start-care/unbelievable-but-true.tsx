    ...
    <section className="bg-[#171514] py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="text-left">
          <p className="text-red-800 text-extrabold text-center text-2xl md:text-3xl font-serif italic mb-4">"1년 내 폐업 이라구요?"</p>
          <br />
          <h2 className="text-white text-4xl md:text-5xl font-bold">믿기지 않겠지만,<br />사실입니다.</h2>
        </div>
