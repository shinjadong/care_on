...
export default function CareonApplicationFormWithSlack({ useGrid = false, onSuccess }: Props) {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // Database Webhook이 자동으로 Slack 알림을 보내고
      // 안드로이드 폰에서 SMS를 발송합니다
      console.log('신청 완료 - Database Webhook을 통해 SMS 발송 예정')
