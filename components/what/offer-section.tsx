...
export function WhatOfferSection() {
  ...
  return (
    <section className="py-20 md:py-24 bg-gray-50" id="apply">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        {/* 🛡️ 100% 폐업 보장 */}
        <motion.div 
          className="bg-gradient-to-r from-yellow-100 to-orange-100 border-2 border-yellow-300 p-8 rounded-3xl text-center mb-12"
        ...
        >
          ...
          <p className="text-lg text-yellow-700 leading-relaxed">
            1년 내 폐업시 사용 금액 전액 환급<br />
            <small className="text-sm text-yellow-600">* TV 결합 고객 한정</small>
          </p>
        </motion.div>
        ...
        >
          ...
          >
            투자 라운드 참여하기
            <span className="ml-2 text-sm bg-white text-teal-600 px-3 py-1 rounded-full">
              선착순 20개
            </span>
          </Link>
        </motion.div>
