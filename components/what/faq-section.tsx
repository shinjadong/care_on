...
const faqData: FAQItem[] = [
  ...
  // 🔥 체험단 특별함 강조
  {
    ...
    icon: AlertCircle,
    category: "체험단",
    question: "체험단과 스타트 케어가 어떻게 다른가요?",
    answer: "스타트 케어는 **'폐업 시 환급 보장'** 서비스입니다.\n\n하지만 이번 오픈 기념 체험단(30명 한정)은 **폐업 보장을 넘어서 아예 1년 완전 무료**입니다.\n\n조건은 **설치 완료 후 사진/영상 촬영 및 후기 작성**뿐입니다.\n\n케어온 포트폴리오 구축을 위한 **단 한 번뿐인 기회**입니다.",
  ...
  // 📋 체험단 자격/조건
  {
    ...
    answer: "**30명 한정**이며 다음 조건을 만족해야 합니다.\n\n① **사업자등록증 보유**\n\n② **실제 매장 운영 중**\n\n③ **설치 후 사진/영상 촬영 협조**\n\n④ **업종 제한 없음**(단, 유흥업소 제외)",
    highlight: "30명만"
  },
  {
    id: 5,
  ...
  // 📦 제품/서비스 관련  
  {
    ...
    answer: "**KT, SK, LG , 삼성, LG ** 등 국내 대기업 정품만 사용합니다.\n\n모든 제품은 **제조사 정식 A/S가 가능**합니다.",
    highlight: "대기업 정품 100%"
  },
  {
    id: 9,
    icon: Zap,
  ...
  },
  {
    ...
    answer: "**설치비나 위약금이 아닌, 장기 고객 유지를 통해 수익을 창출**하는 구조입니다.\n\n특히 **체험단은 케어온의 포트폴리오와 신뢰도 구축이 목적**입니다.\n\n**사장님이 성공해야 저희도 성공하는 상생 구조**입니다.",
