...
import { ChevronDown, HelpCircle, Shield, Clock, CreditCard, AlertCircle, Users, Zap, FileCheck, Phone } from "lucide-react"
...
const faqData: FAQItem[] = [
  // 🎯 스타트 케어 기본 개념
  {
    ...
    answer: "스타트 케어는 **창업 1년간 폐업 위험을 보장**하는 케어온의 핵심 서비스입니다. CCTV 보안, GIGA 인터넷, TV, 보험 등 창업 필수 인프라를 제공합니다.\n\n만약 **1년 내 폐업 시 납부하신 모든 월 이용료를 100% 환급**해드립니다. 창업 초기 시행착오의 부담을 덜어드리는 것이 목적입니다.",
  ...
  // 🔥 체험단 특별함 강조
  {
    ...
    answer: "일반 스타트 케어는 **'폐업 시 환급 보장'** 서비스입니다. 하지만 이번 오픈 기념 체험단(50명 한정)은 **폐업 보장을 넘어서 아예 1년 완전 무료**입니다.\n\n조건은 **설치 완료 후 사진/영상 촬영 및 후기 작성**뿐입니다. 케어온 포트폴리오 구축을 위한 **단 한 번뿐인 기회**입니다.",
  ...
  },
  {
    ...
    answer: "네, **설치비부터 1년간 모든 이용료까지 완전 무료**입니다. CCTV 4대 + 기가 인터넷 + TV 패키지 기준 **일반 가격 연 180만원 상당을 무료**로 제공합니다.\n\n**숨겨진 비용, 보증금, 위약금 모두 없습니다.** 진짜 무료가 맞습니다.",
  ...
  // 📋 체험단 자격/조건
  {
    ...
    answer: "**50명 한정**이며 다음 조건을 만족해야 합니다. ① **사업자등록증 보유** ② **실제 매장 운영 중**\n\n③ **설치 후 사진/영상 촬영 협조** ④ **업종 제한 없음**(단, 유흥업소 제외). 선착순 마감이므로 서둘러 신청하세요.",
  ...
  },
  {
    ...
    answer: "**온라인 신청 → 24시간 내 전화 확인 → 48시간 내 현장 견적**으로 진행됩니다. **견적 승인 후 2-3일 내 설치 완료**(총 5일).\n\n현장 견적 시 매장 상태와 설치 조건을 확인한 후 최종 승인됩니다. 조건 미충족 시 일반 스타트 케어로 안내드립니다.",
  ...
  },
  {
    ...
    answer: "전혀 부담스럽지 않습니다. **얼굴이 나올 필요도 없고**, 설치 완료 후 **사진과 영상만 촬영**하면 됩니다.\n\n**케어온 리뷰 게시판에 간단히 작성**해주시면 됩니다. 후기 미작성 시에도 위약금은 없으며, 단지 2년차부터 일반 요금이 적용됩니다.",
  ...
  // 🛡️ 일반 스타트 케어 관련
  {
    ...
    answer: "**CCTV 4대 + 기가 인터넷 + TV 패키지 기준 월 8만원대**입니다. 대기업 직거래 가격보다 **20-30% 저렴한 수준**입니다.\n\n**1년 내 폐업 시 지금까지 납부하신 모든 요금을 100% 환급**해드립니다. 창업 위험 부담을 완전히 없애드립니다.",
  ...
  // 📦 제품/서비스 관련  
  {
    ...
    answer: "**KT AI CCTV, KT/SK/LG 기가 인터넷, 삼성/LG 스마트TV** 등 국내 대기업 정품만 사용합니다. **저가 중국산이나 재생품은 절대 사용하지 않습니다.**\n\n모든 제품은 **제조사 정식 A/S가 가능**합니다. 품질과 신뢰성을 보장합니다.",
  ...
  },
  {
    ...
    answer: "**고장 신고 → 2시간 내 전화 확인 → 6시간 내 기사 방문**으로 진행됩니다. **24시간 내 수리 완료 또는 장비 교체**를 원칙으로 합니다.\n\n**케어온 전담 매니저가 A/S 전 과정을 대행**하므로 여러 업체에 연락할 필요가 없습니다. 원스톱 서비스입니다.",
  ...
  // ❓ 기타 궁금증
  {
    ...
    answer: "일반 렌탈사는 **설치비와 위약금으로 수익**을 냅니다. 초기엔 관리가 잘 되지만, **A/S 신청 시 확인이 불편하고 고객 정보 관리가 허술**합니다.\n\n케어온은 **한 곳에서 모든 렌탈 장비를 오랫동안 안정적으로 관리**해드리는 것이 목적입니다. 장기 파트너십이 핵심입니다.",
    highlight: "원스톱 통합 관리"
  },
  {
    id: 11,
    ...
    answer: "솔직히 말하면 **저희도 수익이 있습니다.** 다만 **설치비나 위약금이 아닌, 장기 고객 유지를 통해 수익을 창출**하는 구조입니다.\n\n특히 **체험단은 케어온의 포트폴리오와 신뢰도 구축이 목적**이므로 파격적 조건이 가능합니다. **사장님이 성공해야 저희도 성공하는 상생 구조**입니다.",
        ...
        >
          <div className="bg-gradient-to-r from-teal-50 to-blue-50 rounded-3xl p-8 md:p-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-8 py-4 bg-teal-600 text-white font-bold rounded-full hover:bg-teal-700 transition-all duration-300 transform hover:scale-105">
                1:1 채팅 상담
              </button>
              <button className="px-8 py-4 bg-white text-teal-600 font-bold rounded-full border-2 border-teal-600 hover:bg-teal-50 transition-all duration-300">
                전화 상담 예약
              </button>
            </div>
          </div>
